### Instructions to be followed for submitting data for Newsletter 2022
...
10. In the folder of your respective department, you will find a folder named `Images` and a file named `x.md` where x is abbreviation of your department, like CSE.md for Computer Science and Engineering.
